...
@section('content')
<!-- Modal -->
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="AlgemeneAfspraken" aria-hidden="true">
...
<script>$('#AlgemeneAfspraken').modal('show')</script>
@endsection
