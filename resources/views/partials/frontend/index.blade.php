...
@section('content')
<!-- Modal -->
<div class="modal fade" id="AlgemeneAfspraken" tabindex="-1" role="dialog" aria-labelledby="AlgemeneAfspraken" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route("accepted") }}">
        <div class="modal-footer">
            <div class="form-check">
		<input type="checkbox" class="form-check-input" id="exampleCheck1">
		<label class="form-check-label" for="exampleCheck1">Gelezen en goedgekeurd</label>
            </div>
